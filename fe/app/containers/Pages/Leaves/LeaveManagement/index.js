                ...
                customBodyRender: (value, rowValue) => {
                    return (
                        ...
                        <Box display={'flex'} gridColumnGap={8}>
                            <Button
                                onClick={() => { requestDecision('APPROVED', rowValue.rowData[0].id)}}
                                variant="contained"
                                size='small'
                                style={{
                            ...
                            <Button
                                onClick={() => { requestDecision('REJECTED', rowValue.rowData[0].id) }}
                                variant="contained"
                                size='small'
                                style={{
                                    textTransform: 'capitalize',
            ...
            <div key={reloadKey}>
                ...
                <Paper elevation={2} >
                    ...
                    <TabPanel tabIndex={1} tabValue={tabValue} forceRender={forceRender}>
                        <Box p={0}>
                            <LeaveManagementCalendar baseApiUrl={baseApiUrl} id={detailProfile.id} requestDecision={requestDecision}/>
                        </Box>
                    </TabPanel>
                </Paper>
            </div>
